...
test() {
  ...
  local build_namespace="basic-spring-boot-build"
  local build_pipline="basic-spring-boot-pipeline"
...
cleanup() {
  echo "cleanup - $(pwd)"
  oc delete project/basic-spring-boot-build project/basic-spring-boot-dev project/basic-spring-boot-stage project/basic-spring-boot-prod --ignore-not-found
}
