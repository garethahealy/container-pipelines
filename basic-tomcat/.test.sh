...
test() {
  ...
  local build_namespace="basic-tomcat-build"
  local build_pipline="basic-tomcat-pipeline"
...
cleanup() {
  echo "cleanup - $(pwd)"
  oc delete project/basic-tomcat-build project/basic-tomcat-dev project/basic-tomcat-stage project/basic-tomcat-prod --ignore-not-found
}
